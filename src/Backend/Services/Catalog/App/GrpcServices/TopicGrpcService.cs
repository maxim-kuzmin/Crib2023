...
public class TopicGrpcService : GrpcServerOfTopic
{
    ...
    private static CatalogTopicEntityForItem CreateEntityForItem(TopicDomainEntityForItem source)
    {
    ...
    private static CatalogTopicEntityForList CreateEntityForList(TopicDomainEntityForList source)
    {
        CatalogTopicEntityForList result;
    ...
    private static CatalogTopicEntityForTree CreateEntityForTree(TopicDomainEntityForTree source)
    {
