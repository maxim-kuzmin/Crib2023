...
public static class DomainExtension
{
    ...
    public static IQueryable<MapperArticleTypeEntity> ApplyFiltering(
        this IQueryable<MapperArticleTypeEntity> query,
    ...
    public static IQueryable<MapperArticleTypeEntity> ApplySorting(
        this IQueryable<MapperArticleTypeEntity> query,
        ArticleListGetOperationInput input
        )
    {
        ...
        {
            query = ((IOrderedQueryable<MapperArticleTypeEntity>)query).ThenBy(x => x.Id);
        }
