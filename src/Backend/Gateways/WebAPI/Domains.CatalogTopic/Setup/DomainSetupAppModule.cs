...
public class DomainSetupAppModule : AppModule
{
    ...
    public sealed override void ConfigureServices(IServiceCollection services)
    {
        ...
        services.AddTransient<ICatalogTopicItemGetOperationHandler>(x => new DomainItemGetOperationHandler(
        ...
        services.AddTransient<ICatalogTopicListGetOperationHandler>(x => new DomainListGetOperationHandler(
            x.GetRequiredService<IDomainResource>(),
            x.GetRequiredService<IOperationResource>(),
