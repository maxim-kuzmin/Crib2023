...
public class DomainListGetOperationRequest : IRequest<DomainListGetOperationResponse>
{
    ...
    /// Входные данные.
    /// </summary>
    public CatalogTopicListGetOperationInput Input { get; init; }
    ...
    public DomainListGetOperationRequest(CatalogTopicListGetOperationInput input, string operationCode = "")
    {
        Input = input;
